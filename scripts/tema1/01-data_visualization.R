...
#Elección manual de estéticas, color= "red" esta defora de la funci� aes, es un valor global
ggplot(data = mpg) + 
...
#intrucci� per veure la darrera gr�fica emprada.
...
#aqu� feim un filtre a on displ < 5 
...
#proves per treure gr�fica amb percentatges no funciona b�
...
?stat # com funciona la funci� stat
